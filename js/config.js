...
// Supabase 项目设置 → API 页面里的 Project URL 与 anon public key。
// anon key 设计上可以公开（它只有 RLS 允许的权限）。
export const SUPABASE_URL = 'https://YOUR-PROJECT-REF.supabase.co';
export const SUPABASE_ANON_KEY = 'YOUR-ANON-KEY';

// Edge Function 地址：https://<project-ref>.supabase.co/functions/v1/parse
export const PARSE_FN_URL = 'https://YOUR-PROJECT-REF.supabase.co/functions/v1/parse';
